...
const STR = {
  ru: {
    ...
    notes: 'Примечания',
    choose10: 'Выберите минимум 8 фото из галереи. Ракурсы:',
    chosen: (n:number)=>`Выбрано: ${n} (минимум 8)`,
    send: 'Отправить',
    sending: 'Отправка…',
    done: 'Готово ✔ Письмо отправлено.',
    needField: (k:string)=>`Заполни поле: ${k}`,
    must10: (n:number)=>`Мало фото: ${n}. Нужно минимум 8.`,
  ...
  en: {
    ...
    chosen: (n:number)=>`Selected: ${n} (min 8)`,
    send: 'Send',
    sending: 'Sending…',
    done: 'Done ✔ Email sent.',
    needField: (k:string)=>`Fill the field: ${k}`,
    must10: (n:number)=>`Too few photos: ${n}. Minimum is 8.`,
