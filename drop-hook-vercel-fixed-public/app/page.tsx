...
const STR = {
  ru: {
    brand: 'US Team Fleet',
    title: 'Drop / Hook',
    policy: 'Каждый водитель обязан отправлять фото при взятии или оставлении трейлера — иначе будут штрафы. Нужно загрузить ровно 10 фото по списку ниже.',
    type: 'Тип',
    hook: 'Hook',
    drop: 'Drop',
    truck: 'Truck #',
  ...
  en: {
    brand: 'US Team Fleet',
    title: 'Drop / Hook',
    policy: 'Every driver must submit photos when hooking or dropping a trailer — penalties otherwise. Upload exactly 10 photos as listed below.',
    type: 'Type',
    hook: 'Hook',
    drop: 'Drop',
    truck: 'Truck #',
    ...
    droptr: 'Trailer left (if none — write none)',
    notes: 'Notes',
